...
//            return mYuvFrameData.submat(0, mHeight, 0, mWidth);
            ...
            adjustOrientation(mYuvFrameData.submat(0, mHeight, 0, mWidth),
                    portrait_gray);
        ...
        public Mat rgba() {
            ...
            adjustOrientation(mRgba, portrait_rgba);

            return portrait_rgba;
        }

        private void adjustOrientation(Mat from, Mat to) {
            int orientation = getResources().getConfiguration().orientation;
            if (orientation == Configuration.ORIENTATION_PORTRAIT) {
                Core.rotate(from, to, Core.ROTATE_90_COUNTERCLOCKWISE);
            } else {
                Core.rotate(from, to, Core.ROTATE_90_CLOCKWISE);
            }
            Core.flip(to, to, 1);
        }
